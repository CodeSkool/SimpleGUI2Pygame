...
#
# From http://www.pygame.org/wiki/Pygame2exe
...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "breakout.py"

        #Name of program
        self.project_name = "Breakout"

        #Project url
        self.project_url = "http://www.youtube.com/user/TheCodeskool101"
        ...
        #Auhor of program
        self.author_name = "Codeskool"
        self.author_email = "example@example.com"
        self.copyright = "Copyright (c) 2013 CodeSkool."

        #Description
        self.project_description = "Clone of Brick"
        ...
        #Dist directory
        self.dist_dir = '..\\' + self.project_name + '\\dist'
