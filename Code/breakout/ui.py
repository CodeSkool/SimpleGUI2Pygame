...
##    def add_special_button(self, screen, image, screen_position, btn_size,
##                           img_pos, func_call, hover_offset=(0,0),
##                           press_offset=(0,0), disable_offset=(0,0))
##
##        button = pgxtra.SpecialButton(screen, image, screen_position, btn_size,
##                                      img_pos, func_call, hover_offset=(0,0),
##                                      press_offset=(0,0), disable_offset=(0,0))
##        button.enabled = True
##        self.controls.append(button)
